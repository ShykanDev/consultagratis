      ...
      <section class="animate-fade">
        ...
        <section class="flex flex-col items-center p-8 md:flex-row">
          <div class="space-y-4 md:w-1/2">
            ...
            <p>Contacta a los expertos desde diferentes medios para resolver todas tus dudas, inquietudes o tener
              consultas y asesorías de forma sencilla y rápida.</p>
            ...
            <div class="flex space-x-4">
              <RouterLink to="/horarios" class="px-4 py-2 font-semibold text-white bg-orange-500 rounded">HORARIOS DE
                LOS EXPERTOS <v-icon name="md-schedule" scale="1.2" /></RouterLink>
              <RouterLink to="/about" class="px-4 py-2 font-semibold text-white bg-sky-800 rounded">SABER MÁS DEL
                SITIO <v-icon class="ml-2" name="md-infooutline" scale="1.2" /></RouterLink>
            </div>
          </div>
        ...
        <RouterLink to="/upcomingAlerts" class="px-4 py-2 font-semibold text-white bg-sky-800 rounded">PREGUNTA A UN
        ...
        <section class="grid grid-cols-1 gap-4 p-8 md:grid-cols-3">
          <a target="_blank" href="https://miempleador.com"
            class="p-2 text-center rounded-3xl border border-sky-900 hover:bg-slate-200">
          ...
          <a target="_blank" href="https://misreclamos.com"
            class="p-2 text-center rounded-3xl border border-sky-900 hover:bg-slate-200">
            <p class="text-sm text-gray-500">Publicidad</p>
          ...
          <a target="_blank" href="https://miarrendador.com"
            class="p-2 text-center rounded-3xl border border-sky-900 hover:bg-slate-200">
            <p class="text-sm text-gray-500">Publicidad</p>
        ...
        <section class="p-8 bg-gray-100">
          ...
          <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
            ...
            <div class="overflow-hidden relative col-span-2 h-64 rounded shadow">
              <img src="../assets/img/publicidad-index.jpg"
                class="object-cover absolute inset-0 w-full h-full brightness-75" alt="Marketing" />
              <div class="flex relative z-10 flex-col justify-end p-4 h-full text-white">
                ...
                <RouterLink :to="{ name: 'experts' }" class="px-3 py-2 mt-4 text-white bg-blue-800 rounded">PREGUNTA A
                  UN
                  EXPERTO</RouterLink>
              </div>
            </div>
            ...
            <div class="overflow-hidden relative h-64 rounded shadow">
              <img src="../assets/img/doctor-index.jpg"
                class="object-cover absolute inset-0 w-full h-full brightness-75" alt="Marketing" />
              <div class="flex relative z-10 flex-col justify-end p-4 h-full text-white">
                <h3 class="text-lg font-semibold text-yellow-400">Marketing</h3>
                <p class="text-sm">¿Necesitas conocer mejor a tu consumidor?</p>
            ...
            <!-- Arquitecto -->
            <div class="overflow-hidden relative h-64 rounded shadow">
              <img src="../assets/img/arquitectura-index.jpg"
                class="object-cover absolute inset-0 w-full h-full brightness-75" alt="Marketing" />
              <div class="flex relative z-10 flex-col justify-end p-4 h-full text-white">
            ...
            <!-- Contadores -->
            <div class="overflow-hidden relative h-64 rounded shadow">
              <img src="../assets/img/contador-index.jpg"
                class="object-cover absolute inset-0 w-full h-full brightness-75" alt="Marketing" />
              <div class="flex relative z-10 flex-col justify-end p-4 h-full text-white">
            ...
            <!-- Servicios WEB -->
            <div class="overflow-hidden relative h-64 rounded shadow">
              <img src="../assets/img/web-index.jpg" class="object-cover absolute inset-0 w-full h-full brightness-75"
                alt="Marketing" />
              <div class="flex relative z-10 flex-col justify-end p-4 h-full text-white">
          ...
          <!-- ¿Cómo Funciona? -->
          <section class="p-6 mx-auto my-10 w-full bg-amber-400 rounded-md">
            ...
            <form class="space-y-4">
              ...
              <h3 class="text-lg font-bold text-gray-800">Con diferentes herramientas de comunicación sean via texto,
                llamada o videollamada podrás comunicarte con el profesional para aclarar tus dudas de forma sencilla y
                rápida</h3>
              <p class="px-2 py-3 text-sm bg-white rounded font-openSans">¿Tiene algún costo?</p>
              <h3 class="text-lg font-bold text-gray-800">La página tiene una pregunta de prueba con una duración máxima
                de 15 minutos, sea en llamada, videollamada o en texto</h3>
              <p class="px-2 py-3 text-sm bg-white rounded font-openSans">¿Qué tan segura es?</p>
              <h3 class="text-lg font-bold text-gray-800">Los expertos han firmado un contrato de confidecialidad para
                llevar sus casos de forma remota con la mayor seguridad y ética profesional</h3>
              <RouterLink :to="{ name: 'help' }" class="px-4 py-2 text-white bg-blue-900 rounded hover:bg-blue-800">
                SABER MÁS
              </RouterLink>
            </form>
          </section>
          ...
          <section class="grid grid-cols-1 gap-6 px-6 my-10 md:grid-cols-2">
            <img src="https://images.pexels.com/photos/1181352/pexels-photo-1181352.jpeg" alt="Personas trabajando"
              class="w-full rounded" />
            <img src="https://images.pexels.com/photos/3182759/pexels-photo-3182759.jpeg" alt="Grupo colaborando"
              class="w-full rounded" />
          </section>
          ...
          <section class="px-6 py-10 text-center bg-gray-100">
            ...
            <RouterLink :to="{ name: 'register' }" class="px-6 py-2 text-white bg-blue-900 rounded hover:bg-blue-800">
              ¡UNIRME!
            </RouterLink>
          </section>
        ...
        <div class="w-full">
          ...
          <div class="flex flex-col gap-8 items-center p-8 md:flex-row">
            ...
            <div class="flex flex-col gap-4 md:w-1/2">
              ...
              <RouterLink :to="{ name: 'register' }" class="px-6 py-2 mt-2 text-white bg-blue-900 rounded w-fit">
                ¡UNIRME!</RouterLink>
            </div>
          </div>
            ...
            <div class="grid gap-6 md:grid-cols-2">
              <div class="flex flex-col gap-2">
                ...
                <div>
                  ...
                  <RouterLink :to="{ name: 'experts' }" class="text-sm text-rose-700 underline font-openSans">Pregunta a
                    un experto --&gt;</RouterLink>
                </div>
              </div>
              <div class="flex flex-col gap-2">
          ...
          <!-- Botón flotante -->
          <RouterLink :to="{ name: 'experts' }"
            class="fixed bottom-4 left-4 z-50 px-4 py-2 text-sm text-white bg-blue-800 rounded hover:bg-blue-900">
            Contactar Profesional
          </RouterLink>
        </div>
